...
namespace LibraryManagementSystem.Controllers
{
    public class UserTablesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.EmployeeID = new SelectList(db.EmployeeTables.Where(u => u.IsActive == true), "EmployeeID", "Email");
        ...
        public ActionResult Create(UserTable userTable)
        {
            ...
            ViewBag.EmployeeID = new SelectList(db.EmployeeTables.Where(u => u.IsActive == true), "EmployeeID", "Email", userTable.EmployeeID);
